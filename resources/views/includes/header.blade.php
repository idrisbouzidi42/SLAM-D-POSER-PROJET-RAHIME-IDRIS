                    ...
                    <div class="text-container">
                        ...
                        <div class="btn-header">
                            <div class="button-4 mx-auto mt-4">
                                <div class="eff-4"></div>
                                <a href="{{ url('offres/create') }}" class="cd-btn js-cd-panel-trigger"
                                    data-panel="main">Publier une offre d'emploi</a>
                            </div>
                            <div class="button-4 mx-auto mt-4">
                                <div class="eff-4"></div>
                                <a href="{{ url('demandes/create') }}" class="cd-btn js-cd-panel-trigger"
                                    data-panel="main">Publier une demande + CV</a>
                            </div>
                        </div>
