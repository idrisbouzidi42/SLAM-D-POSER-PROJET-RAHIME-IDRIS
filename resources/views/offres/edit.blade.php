            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select name="teleTravailOffre" id="teleTravailOffre"
                        ...
                        value="{{ old('teleTravailOffre') ?? ''}}">
                        <option value=""></option>
                        <option {{  old('teleTravailOffre') == 'oui' ? 'selected' : '' }} {{$offre->teleTravailOffre == 'oui' ?
                            'selected' : '' }} value=oui>
                            Oui
                        </option>
                        <option
                            {{ old('teleTravailOffre') == 'non' ? 'selected': $offre->teleTravailOffre == 'non' ? 'selected' : ''}}
                            value='non'>
                            Non</option>
                    </select>
